...
(function (f, g, j, b) {
    ...
    f.transform.prototype = {
        exec: function (s, t) {
            ...
            var K = parseFloat(C.e(1, 1).toFixed(6)), I = parseFloat(C.e(2, 1).toFixed(6)),
                H = parseFloat(C.e(1, 2).toFixed(6)), G = parseFloat(C.e(2, 2).toFixed(6)),
    ...
    d.extend(d.transform.prototype, {
        safeOuterHeight: function () {
            ...
            if (!d.support.csstransforms && d.browser.msie) {
                ...
                var h = this.$elem[0], j = parseFloat(d.curCSS(h, l, true)), q = this.boxSizingProperty,
...
(function (f, e, b, g) {
    ...
    var c = {
        e: function (k, h) {
            ...
            var v = this.e(1, 1), t = this.e(2, 1), q = this.e(1, 2), p = this.e(2, 2), o = this.e(1, 3),
                n = this.e(2, 3);
...
(function (c, b, a, d) {
    ...
    c.matrix.calc.prototype = {
        coord: function (e, i, h) {
            ...
            }, f = {x: h.bl.e(1) - h.tl.e(1) + h.br.e(1) - h.tr.e(1), y: h.bl.e(2) - h.tl.e(2) + h.br.e(2) - h.tr.e(2)};
